      ...
      <div className="flex-1 flex flex-col bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 p-6 border-b border-slate-100 bg-white">
          ...
          <button 
              ...
              className="flex items-center gap-2 bg-[#1d4ed8] hover:bg-blue-800 text-white px-4 py-2 rounded-md text-sm font-medium transition-colors shadow-sm"
          >
            <Upload size={16} />
            {t.btnUpload}
          </button>
        ...
        <div className="p-6 border-b border-slate-100 bg-slate-50/50 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="flex items-end gap-2">
              ...
              <button className="flex-1 bg-[#1d4ed8] hover:bg-blue-800 text-white px-4 py-2 rounded-md text-sm font-medium transition-colors shadow-sm">
                {t.btnSearch}
              </button>
            </div>
          </div>
              ...
              <div className="bg-white rounded-xl shadow-2xl w-full max-w-md mx-4 relative animate-in zoom-in-95 duration-200 overflow-hidden">
                  ...
                  <div className="px-6 py-4 border-t border-slate-100 bg-slate-50/50 flex gap-3 justify-end">
                      ...
                      <button 
                          ...
                          className="px-6 py-2 bg-[#1d4ed8] text-white rounded-lg text-sm font-medium hover:bg-blue-700 shadow-sm transition-colors"
                      >
                          {t.btnStartRead}
                      </button>
                  </div>
